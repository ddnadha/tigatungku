        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="card card-statistic-2">
                <div class="card-stats">
                    <div class="card-stats-title">Order Statistics -
                        <div class="dropdown d-inline">
                            ...
                            <ul class="dropdown-menu dropdown-menu-sm">
                                <?php for($i = 1; $i <= 12; $i++) : ?>
                                    <li><a href="<?= base_url('/admin/?ordermonth='.$i) ?>" class="dropdown-item"><?= date('F', mktime(0, 0, 0, $i, 10)) ?></a></li>
                                <?php endfor; ?>
                            </ul>
                        </div>
                    </div>
                    <div class="card-stats-items">
                        <div class="card-stats-item">
                            <div class="card-stats-item-count"><?= @$trx_pending ?></div>
                            <div class="card-stats-item-label">Pending</div>
                        </div>
                        <div class="card-stats-item">
                            <div class="card-stats-item-count"><?= @$trx_process ?></div>
                            <div class="card-stats-item-label">Shipping</div>
                        </div>
                        <div class="card-stats-item">
                            <div class="card-stats-item-count"><?= @$trx_done ?></div>
                ...
                <div class="card-wrap">
                    ...
                    <div class="card-body">
                        <?= @$trx_pending + @$trx_process + @$trx_done ?>
                    </div>
                </div>
            </div>
        </div>
